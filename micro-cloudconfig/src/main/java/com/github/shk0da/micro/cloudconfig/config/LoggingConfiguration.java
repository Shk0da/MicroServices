package com.github.shk0da.micro.cloudconfig.config;
...
public class LoggingConfiguration {
    ...
    public LoggingConfiguration(@Value("${spring.application.name}") String appName,
                                ...
                                @Value("${cloudconfig.logging.logstash.enabled:false}") Boolean logstashEnabled,
                                @Value("${cloudconfig.logging.logstash.host:localhost}") String logstashHost,
                                @Value("${cloudconfig.logging.logstash.port:5000}") Integer logstashPort,
                                @Value("${cloudconfig.logging.logstash.queue-size:512}") Integer logstashQueueSize,
                                @Value("${cloudconfig.metrics.logs.enabled:false}") Boolean logsEnabled
                                ) {
